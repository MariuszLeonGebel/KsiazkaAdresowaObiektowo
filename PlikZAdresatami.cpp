...
void PlikZAdresatami::usunWybranaLinieWPliku(Adresat adresat) {
    ...
    if (odczytywanyPlikTekstowy.good() == true && adresat.pobierzId() != 0) {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia)) {
            ...
            if((usuwanaLiniaZostalaNapotkana==false) && (adresat.pobierzId() != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))) {
                numerUsuwanejLinii++;
            }
            // Tych przypadkow jest tyle, gdyz chcemy osiagnac taki efekt,
            // aby na koncu pliku nie bylo pustej linii
            if (adresat.pobierzId() == pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia)) {}
            else if (numerWczytanejLinii == 1 && (adresat.pobierzId() != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia)))
